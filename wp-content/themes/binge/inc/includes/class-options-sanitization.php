...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'binge' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'binge' ),
		'repeat-y'  => __( 'Repeat Vertically', 'binge' ),
		'repeat'    => __( 'Repeat All', 'binge' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'binge' ),
		'top center'    => __( 'Top Center', 'binge' ),
		'top right'     => __( 'Top Right', 'binge' ),
		'center left'   => __( 'Middle Left', 'binge' ),
		'center center' => __( 'Middle Center', 'binge' ),
		'center right'  => __( 'Middle Right', 'binge' ),
		'bottom left'   => __( 'Bottom Left', 'binge' ),
		'bottom center' => __( 'Bottom Center', 'binge' ),
		'bottom right'  => __( 'Bottom Right', 'binge')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'binge' ),
		'fixed'  => __( 'Fixed in Place', 'binge')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'binge' ),
		'italic'      => __( 'Italic', 'binge' ),
		'bold'        => __( 'Bold', 'binge' ),
		'bold italic' => __( 'Bold Italic', 'binge' )
		);
